package com.ccav.player;

import java.io.File;
import java.util.ArrayList;

import com.ccav.player.R;
...
public class FilelistActvity extends Activity {
			...
			public void handleMessage(Message msg) {
				if (!Thread.currentThread().isInterrupted()) {
					...
					case MSG_UPDATA_INIT:
						...
						mViewScanInfo.setText("更新列表中...");
						break;
					case MSG_UPDATA_INFO:
						//mViewScanInfo.setText("閹殿偅寮块敍锟�+ msg.obj);
						break;
	...
	private void startPlayer(VideoFile video) {
		...
		intent.setClass(FilelistActvity.this, CCAVPlayer.class);
